...
var routes = [
    ...
    {
        path: 'timer',
        loadChildren: function () { return __webpack_require__.e(/*! import() | timer-timer-module */ "timer-timer-module").then(__webpack_require__.bind(null, /*! ./timer/timer.module */ "./src/app/timer/timer.module.ts")).then(function (m) { return m.TimerPageModule; }); }
    }
];
...
/* harmony import */ var _services_timer_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/timer.service */ "./src/app/services/timer.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, timerService) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.timerService.notificationTimer();
        });
    };
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _services_timer_service__WEBPACK_IMPORTED_MODULE_5__["TimerService"] }
    ]; };
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            ...
            _services_timer_service__WEBPACK_IMPORTED_MODULE_5__["TimerService"]])
    ], AppComponent);
    return AppComponent;
}());
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_tasks_service__WEBPACK_IMPORTED_MODULE_12__["TasksService"],
...
/*!*******************************************!*\
  !*** ./src/app/services/tasks.service.ts ***!
  \*******************************************/
/*! exports provided: Task, TasksService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Task = /** @class */ (function () {
    function Task(id, task, textarea, location, start, end, color, notification) {
...
var TasksService = /** @class */ (function () {
    ...
    TasksService.prototype.addTask = function (task) {
        var _this = this;
        return this.storage.get(STORAGE_KEY).then(function (tasks) {
            var keepTasks = [];
            if (!tasks || tasks.length === 0) {
                keepTasks[0] = task;
                return _this.storage.set(STORAGE_KEY, keepTasks);
            }
            keepTasks = tasks;
            keepTasks.push(task);
            return _this.storage.set(STORAGE_KEY, keepTasks);
    ...
    TasksService.prototype.deleteTasks = function () {
        this.storage.clear();
    };
    TasksService.prototype.updateTask = function (task) {
        ...
        return this.storage.get(STORAGE_KEY).then(function (tasks) {
            ...
            return _this.storage.set(STORAGE_KEY, newTasks);
        });
    };
...
/* harmony import */ var _tasks_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tasks.service */ "./src/app/services/tasks.service.ts");
...
var TimerService = /** @class */ (function () {
    function TimerService(tasksService, localNotifications) {
    ...
    TimerService.prototype.getCurrent = function () {
        return this.current;
    };
    TimerService.prototype.getSecond = function () {
        return this.second;
    };
    ...
    TimerService.prototype.startTimer = function () {
        ...
        if (this.paused) {
            this.subSecond = rxjs_Rx__WEBPACK_IMPORTED_MODULE_2__["Observable"].interval(1000).subscribe(function () {
                _this.second++;
                if (_this.second === 60) {
                    _this.subSecond.unsubscribe();
                    _this.second = 0;
                }
            });
            this.sub = rxjs_Rx__WEBPACK_IMPORTED_MODULE_2__["Observable"].interval(60000 - (this.second * 1000)).subscribe(function () {
                _this.current++;
            ...
            this.sub = rxjs_Rx__WEBPACK_IMPORTED_MODULE_2__["Observable"].interval(60000).subscribe(function () {
                _this.current++;
                if (_this.current === 25) {
                    _this.sub.unsubscribe();
    ...
    TimerService.prototype.notificationTimer = function () {
        var _this = this;
        this.notificationMinute = rxjs_Rx__WEBPACK_IMPORTED_MODULE_2__["Observable"].interval(60000).subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _i, _a, task;
                            ...
                            if (!task.notification) {
                                ...
                                if (this.diff_minutes(new Date(task.start), new Date()) <= 30) {
                                    ...
                                    this.localNotifications.schedule({
                                        title: task.task + ' fél órán belül, itt: ' + task.location,
                                        text: task.textarea
                                    });
                                }
                            }
    ...
    TimerService.prototype.diff_minutes = function (dt2, dt1) {
        var dt2_h = dt2.getHours();
        var dt1_h = dt1.getHours();
        var dt2_m = dt2.getMinutes();
        var dt1_m = dt1.getMinutes();
        var final;
        if (dt2_h - dt1_h > 0) {
            var h = dt2_h - dt1_h;
    ...
    TimerService.prototype.getTasks = function () {
    ...
    TimerService.ctorParameters = function () { return [
...
module.exports = __webpack_require__(/*! D:\Projects\ionic-pomodoro-time-management\pomodoro\src\main.ts */"./src/main.ts");

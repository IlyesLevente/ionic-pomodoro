...
let HomePage = class HomePage {
    constructor(tasksService, timerService) {
    ...
    addTask() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const addTask = new _services_tasks_service__WEBPACK_IMPORTED_MODULE_2__["Task"](this.id, this.task, this.textarea, this.location, this.start, this.end, 'white', false);
